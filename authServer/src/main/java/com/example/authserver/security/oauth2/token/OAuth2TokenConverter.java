...
public class OAuth2TokenConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        TokenResponseBody responseBody = getTokensWithAuthCode(request);
        ...
        oAuth2AuthToken.setAuthenticated(false);
        return oAuth2AuthToken;
    }

    TokenResponseBody getTokensWithAuthCode(HttpServletRequest request) {
